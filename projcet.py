...
def traslate(filename,filename2,filename1):
    lists=fileload(filename)[0]
    my_file=open(filename,'r+')
    files=my_file.readlines()
    my_file.close()
    number=len(files)   
...
traslate('input.pdb','input.pdb','input_translate1.pdb')
traslate('4dnw_reference.pdb','input.pdb','4dnw_reference_t.pdb')
traslate('4dnw_reference_2.pdb','input.pdb','4dnw_reference_2_t.pdb')
fileload('input_translate1.pdb') 
fileload('4dnw_reference_t.pdb')      
fileload('4dnw_reference_2_t.pdb')  
rotate('input_translate1.pdb','input_rotate_z.pdb','4dnw_reference_t.pdb','z',0)
rotate('4dnw_reference_t.pdb','4dnw_reference_t_rotate.pdb','4dnw_reference_t.pdb','z',0)
rotate('4dnw_reference_2_t.pdb','4dnw_reference_2_t_rotate.pdb','4dnw_reference_t.pdb','z',0)   
fileload('input_rotate_z.pdb')  
fileload('4dnw_reference_t_rotate.pdb') 
fileload('4dnw_reference_2_t_rotate.pdb')       
rotate('4dnw_reference_t_rotate.pdb','4dnw_reference_t_rotate_y.pdb','4dnw_reference_t_rotate.pdb','y',0) 
rotate('input_rotate_z.pdb','input_rotate_y.pdb','4dnw_reference_t_rotate.pdb','y',0)
rotate('4dnw_reference_2_t_rotate.pdb','4dnw_reference_2_t_rotate_y.pdb','4dnw_reference_t_rotate.pdb','y',0)
fileload('input_rotate_y.pdb')  
fileload('4dnw_reference_t_rotate_y.pdb')  
fileload('4dnw_reference_2_t_rotate_y.pdb') 
rotate('input_rotate_y.pdb','input_rotate_x.pdb','4dnw_reference_2_t_rotate_y.pdb','x',1)
rotate('4dnw_reference_t_rotate_y.pdb','4dnw_reference_t_rotate_x.pdb','4dnw_reference_2_t_rotate_y.pdb','x',1)
rotate('4dnw_reference_2_t_rotate_y.pdb','4dnw_reference_2_t_rotate_x.pdb','4dnw_reference_2_t_rotate_y.pdb','x',1) 
fileload('input_rotate_x.pdb')  
fileload('4dnw_reference_t_rotate_x.pdb')  
fileload('4dnw_reference_2_t_rotate_x.pdb') 
dimer_rotate('input_rotate_x.pdb','input_rotate_360.pdb','4dnw_reference_t_rotate_x.pdb',10)
